...
enum AppAboutInfo {
    ...
    static let githubURL = URL(string: "https://github.com/uniquejava/EggplantFred")!
    static let githubDisplay = "github.com/uniquejava/EggplantFred"
    static let techStack = """
    SwiftUI + AppKit · CGEvent hotkey tap
    NSWorkspace launch · SMAppService login item
    macOS 14+
    """

    static var appName: String {
        Bundle.main.object(forInfoDictionaryKey: "CFBundleName") as? String ?? "EggplantFred"
    }

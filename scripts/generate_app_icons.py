...
DEST = ROOT / "EggplantFred/Assets.xcassets/AppIcon.appiconset"
CANDIDATES = [
    DEST / "AppIcon-1024-master.png",
    Path.home()
    / ".cursor/projects/Users-cyper-code-eggplant-projects-EggplantFred/assets/AppIcon-1024.png",
]
...
def main() -> None:
    ...
    im = apply_macos_icon_mask(Image.open(src))
    # Keep master masked so future runs stay consistent.
    if src.name == "AppIcon-1024-master.png":
